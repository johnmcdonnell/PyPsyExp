# -*- coding: utf-8 -*-
#
# PyPsyExp documentation build configuration file, created by
...
project = u'PyPsyExp'
copyright = u'2011, Todd Gureckis'
...
latex_documents = [
  ('index', 'PyPsyExp.tex', u'PyPsyExp Documentation',
   u'Todd Gureckis', 'manual'),
]
...
man_pages = [
    ('index', 'pypsyexp', u'PyPsyExp Documentation',
     [u'Todd Gureckis'], 1)
]
